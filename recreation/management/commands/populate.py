...
from recreation.models import Client, House, Facility, Review, Employee, Position, Booking, Event, Service, BookingService, Payment, Post, Tag
    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(10):
            Facility.objects.create(
                ...
                status=fake.random_element(elements=('Available', 'Occupied', 'Maintenance'))
            )
        ...
        for _ in range(10):
            Payment.objects.create(
                ...
                payment_method=fake.random_element(elements=('Кредитная карта', 'Наличные', 'PayPal'))
            )

        self.stdout.write(self.style.SUCCESS('Фиктивные данные успешно добавлены в базу данных!'))
