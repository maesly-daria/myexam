...
def create_positions():
    ...
    positions = [
        ...
        {
            "name": "Бармен",
            "responsibilities": "Обслуживание в баре, приготовление напитков",
        },
        {
            "name": "Экскурсовод",
            "responsibilities": "Проведение экскурсий по окрестностям",
        },
    ]
...
def create_facilities(houses):
    ...
    facilities = [
        {
            ...
            "description": "Сауна, бассейн, комнаты отдыха",
            "status": "Работает",
            "house": houses[0],
        },
        {
            "name": "Мангальная зона",
            "description": "Место для барбекю у реки",
            "status": "Работает",
            "house": houses[1],
        },
        {
        ...
        {
            "name": "SPA-центр",
            "description": "Массаж, косметические процедуры",
            "status": "Работает",
            "house": houses[3],
        },
        {
            "name": "Фитнес-зал",
            "description": "Тренажеры, йога-студия",
            "status": "Работает",
            "house": houses[4],
        },
        {
            "name": "Конференц-зал",
            "description": "Помещение для мероприятий",
            "status": "Работает",
            "house": houses[5],
        },
    ]
    ...
    for fac in facilities:
        safe_get_or_create(
            ...
            name=fac["name"],
            house_id=fac["house"],
            defaults={"description": fac["description"], "status": fac["status"]},
        )
...
def create_services():
    ...
    services = [
        ...
        {
            "name": "Банный чан",
            "description": "Аренда банного чана на 2 часа",
            "price": 3000,
            "quantity": 5,
            "image": "banya.jpg",
        },
        ...
        {
            "name": "Экскурсия",
            "description": "Пешая экскурсия по окрестностям",
            "price": 1000,
            "quantity": 10,
            "image": "excursion.jpg",
        },
        {
            "name": "Трансфер",
            "description": "Доставка от/до города",
            "price": 2000,
            "quantity": 3,
            "image": "transfer.jpg",
        },
        ...
        {
            "name": "Рыбалка",
            "description": "Аренда снастей и лодки",
            "price": 2500,
            "quantity": 6,
            "image": "fishing.jpg",
        },
...
def create_events(bookings):
    ...
    events = [
        ...
        },
        {
            ...
            "booking": bookings[2],
            "image": "kids_party.jpg",
        },
        {
            "name": "Фестиваль барбекю",
            "date": timezone.now() + timedelta(days=60),
            "location": "Мангальная зона",
            "booking": bookings[3],
            "image": "bbq.jpg",
        },
    ]
...
def create_booking_services(bookings, services):
    ...
    for bs in booking_services:
        obj = safe_get_or_create(
            ...
            defaults={"return_date": bs["return_date"]},
        )
        if obj:
